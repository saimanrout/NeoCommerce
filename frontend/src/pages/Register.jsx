  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-lg border border-gray-100 dark:border-slate-700">
        <h1 className="text-3xl font-bold tracking-tight mb-8 text-center">Create Account</h1>
        ...
        <div className="mt-8 text-center text-gray-500">
          ...
          <Link to={redirect ? `/login?redirect=${redirect}` : '/login'} className="text-primary-500 font-semibold hover:underline">
            Login
          </Link>
        </div>
      </div>
